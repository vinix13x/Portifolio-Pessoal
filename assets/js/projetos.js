    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/cronometro.gif"
              alt="GIF do projeto cronometro."
            />
            <div class="buttons">
              <a href="https://github.com/vinix13x/Cronometro-em-Javascript" target="_blank" title="Repositório no Github">
                <svg
              ...
              <a href="https://cronometro-com-javascript-sigma.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Este é um projeto simples de um cronômetro criado com JavaScript puro e estilizações em CSS.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <div class="img-wrapper">
            <img src="./assets/images/projects/consumodeapi.gif" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/vinix13x/React-js-Axios" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://react-js-axios.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Consumindo API de postagens</p>
          <p>React Js - Tailwind - JS</p>
        </div>
        <div class="card">
          <h3>Sabores Globais</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/saboresglobais.gif" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/vinix13x/Sabores-Globais" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://vinix13x.github.io/Sabores-Globais/home.html" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Página de receitas desenvolvida para cliente.</p>
          <p>HTML - CSS - JS</p>
        </div>
        <div></div>
        <div class="card">
